...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-ha.html["Saiba como o storage funciona em um par de HA do Cloud Volumes ONTAP executado na AWS"^].
